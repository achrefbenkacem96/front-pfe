...
import { AppAddSponsorComponent } from './sponsor/add/add.component';
import { AppSponsorComponent, AppSponsorDialogContentComponent } from './sponsor/sponsor.component';
import { AppSponsorTeamComponent, AppSponsorTeamDialogContentComponent } from './sponsorTeam/sponsorTeam.component';
import { AppAddSponsorTeamComponent } from './sponsorTeam/add/add.component';
...
@NgModule({
  ...
  declarations: [
    ...
    AppAddSponsorComponent,
    AppSponsorComponent,
    AppSponsorDialogContentComponent,
    AppSponsorTeamComponent,
    AppSponsorTeamDialogContentComponent,
    AppAddSponsorTeamComponent
  ],
  providers: [DatePipe],
})
